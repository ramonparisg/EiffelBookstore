...
public class FacturaDAO {
    ...
    public int insertar(FacturaBoleta f){
        int res =0;
        String q = "Insert into factura(f_compra,precio_iva,iva,precio_neto,metodo_pago) "
    ...
    public int eliminar(int id){
        int res =0;
        String q ="Delete from factura where folio="+id;
        res = c.ejecutarSQL(q);        
        return res;
    }
    ...
    public FacturaBoleta buscar(int id){
        ...
        String q = "Select * from factura where folio="+id;        
